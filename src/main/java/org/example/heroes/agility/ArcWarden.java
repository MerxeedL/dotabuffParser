...
public class ArcWarden {
    ...
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/arc-warden/abilities";
    ...
    public static void getInfoAboutArcWardenFirstAbility() throws IOException {
    ...
    public static void getInfoAboutArcWardenSecondAbility() throws IOException {
    ...
    public static void getInfoAboutArcWardenThirdAbility() throws IOException {
    ...
    public static void getInfoAboutArcWardenUltimateAbility() throws IOException {
