...
public class Bloodseeker {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Bloodseeker/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Bloodseeker/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/bloodseeker/abilities";
    ...
    public static void getInfoAboutBloodseekerFirstAbility() throws IOException {
    ...
    public static void getInfoAboutBloodseekerSecondAbility() throws IOException {
    ...
    public static void getInfoAboutBloodseekerThirdAbility() throws IOException {
    ...
    public static void getInfoAboutBloodseekerUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutBloodseekerChangelogs() throws IOException {
    ...
    public static void getInfoAboutBloodseekerChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutBloodseekerTalents() throws IOException {
