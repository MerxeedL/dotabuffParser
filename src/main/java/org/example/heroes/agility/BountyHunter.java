...
public class BountyHunter {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Bounty_Hunter/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Bounty_Hunter/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/bounty-hunter/abilities";
    public static void getInfoAboutBountyHunter() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/bounty-hunter").get();
    ...
    public static void getInfoAboutBountyHunterIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/bounty-hunter/counters/").get();
    ...
    public static void getInfoAboutBountyHunterCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/bounty-hunter/counters/").get();
    ...
    public static void getInfoAboutBountyHunterFirstAbility() throws IOException {
    ...
    public static void getInfoAboutBountyHunterSecondAbility() throws IOException {
    ...
    public static void getInfoAboutBountyHunterThirdAbility() throws IOException {
    ...
    public static void getInfoAboutBountyHunterUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutBountyHunterChangelogs() throws IOException {
    ...
    public static void getInfoAboutBountyHunterChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutBountyHunterTalents() throws IOException {
