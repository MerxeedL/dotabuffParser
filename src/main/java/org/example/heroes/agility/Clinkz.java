...
public class Clinkz {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Clinkz/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Clinkz/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/clinkz/abilities";
    public static void getInfoAboutClinkz() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/clinkz").get();
    ...
    public static void getInfoAboutClinkzIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/clinkz/counters/").get();
    ...
    public static void getInfoAboutClinkzCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/clinkz/counters/").get();
    ...
    public static void getInfoAboutClinkzFirstAbility() throws IOException {
    ...
    public static void getInfoAboutClinkzSecondAbility() throws IOException {
    ...
    public static void getInfoAboutClinkzThirdAbility() throws IOException {
    ...
    public static void getInfoAboutClinkzUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutClinkzChangelogs() throws IOException {
    ...
    public static void getInfoAboutClinkzChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutClinkzTalents() throws IOException {
