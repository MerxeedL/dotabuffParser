...
public class DrowRanger {
    ...
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/drow-ranger/abilities";
    ...
    public static void getInfoAboutDrowRangerFirstAbility() throws IOException {
    ...
    public static void getInfoAboutDrowRangerSecondAbility() throws IOException {
    ...
    public static void getInfoAboutDrowRangerThirdAbility() throws IOException {
    ...
    public static void getInfoAboutDrowRangerUltimateAbility() throws IOException {
