...
public class EmberSpirit {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Ember_Spirit/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Ember_Spirit/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/ember-spirit/abilities";
    public static void getInfoAboutEmberSpirit() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ember-spirit").get();
    ...
    public static void getInfoAboutEmberSpiritIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ember-spirit/counters/").get();
    ...
    public static void getInfoAboutEmberSpiritCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ember-spirit/counters/").get();
    ...
    public static void getInfoAboutEmberSpiritFirstAbility() throws IOException {
    ...
    public static void getInfoAboutEmberSpiritSecondAbility() throws IOException {
    ...
    public static void getInfoAboutEmberSpiritThirdAbility() throws IOException {
    ...
    public static void getInfoAboutEmberSpiritUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutEmberSpiritChangelogs() throws IOException {
    ...
    public static void getInfoAboutEmberSpiritChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutEmberSpiritTalents() throws IOException {
