...
public class FacelessVoid {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Faceless_Void/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Faceless_Void/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/faceless-void/abilities";
    ...
    public static void getInfoAboutFacelessVoidCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/faceless-void/counters/").get();
    ...
    public static void getInfoAboutFacelessVoidFirstAbility() throws IOException {
    ...
    public static void getInfoAboutFacelessVoidSecondAbility() throws IOException {
    ...
    public static void getInfoAboutFacelessVoidThirdAbility() throws IOException {
    ...
    public static void getInfoAboutFacelessVoidUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutFacelessVoidChangelogs() throws IOException {
    ...
    public static void getInfoAboutFacelessVoidChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutFacelessVoidTalents() throws IOException {
