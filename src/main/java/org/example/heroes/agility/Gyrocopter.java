...
public class Gyrocopter {
    ...
    public static void getInfoAboutGyrocopterChangelogs() throws IOException {
    ...
    public static void getInfoAboutGyrocopterChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutGyrocopterTalents() throws IOException {
