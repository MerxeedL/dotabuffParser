...
public class Hoodwink {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Hoodwink/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Hoodwink/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/hoodwink/abilities";
    public static void getInfoAboutHoodwink() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/hoodwink").get();
    ...
    public static void getInfoAboutHoodwinkIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/hoodwink/counters/").get();
    ...
    public static void getInfoAboutHoodwinkCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/hoodwink/counters/").get();
    ...
    public static void getInfoAboutHoodwinkFirstAbility() throws IOException {
    ...
    public static void getInfoAboutHoodwinkSecondAbility() throws IOException {
    ...
    public static void getInfoAboutHoodwinkThirdAbility() throws IOException {
    ...
    public static void getInfoAboutHoodwinkUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutHoodwinkChangelogs() throws IOException {
    ...
    public static void getInfoAboutHoodwinkChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutHoodwinkTalents() throws IOException {
