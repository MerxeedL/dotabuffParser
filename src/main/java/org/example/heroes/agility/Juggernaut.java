...
public class Juggernaut {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Juggernaut/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Juggernaut/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/juggernaut/abilities";
    public static void getInfoAboutJuggernaut() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/juggernaut").get();
    ...
    public static void getInfoAboutJuggernautIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/juggernaut/counters/").get();
    ...
    public static void getInfoAboutJuggernautCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/juggernaut/counters/").get();
    ...
    public static void getInfoAboutJuggernautFirstAbility() throws IOException {
    ...
    public static void getInfoAboutJuggernautSecondAbility() throws IOException {
    ...
    public static void getInfoAboutJuggernautThirdAbility() throws IOException {
    ...
    public static void getInfoAboutJuggernautUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutJuggernautChangelogs() throws IOException {
    ...
    public static void getInfoAboutJuggernautChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutJuggernautTalents() throws IOException {
