...
public class Luna {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Luna/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Luna/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/luna/abilities";
    public static void getInfoAboutLuna() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/luna").get();
    ...
    public static void getInfoAboutLunaIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/luna/counters/").get();
    ...
    public static void getInfoAboutLunaCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/luna/counters/").get();
    ...
    public static void getInfoAboutLunaFirstAbility() throws IOException {
    ...
    public static void getInfoAboutLunaSecondAbility() throws IOException {
    ...
    public static void getInfoAboutLunaThirdAbility() throws IOException {
    ...
    public static void getInfoAboutLunaUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutLunaChangelogs() throws IOException {
    ...
    public static void getInfoAboutLunaChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutLunaTalents() throws IOException {
