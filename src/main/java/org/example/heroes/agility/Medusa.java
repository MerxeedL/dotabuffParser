...
public class Medusa {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Medusa/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Medusa/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/medusa/abilities";
    public static void getInfoAboutMedusa() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/medusa").get();
    ...
    public static void getInfoAboutMedusaIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/medusa/counters/").get();
    ...
    public static void getInfoAboutMedusaCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/medusa/counters/").get();
    ...
    public static void getInfoAboutMedusaFirstAbility() throws IOException {
    ...
    public static void getInfoAboutMedusaSecondAbility() throws IOException {
    ...
    public static void getInfoAboutMedusaThirdAbility() throws IOException {
    ...
    public static void getInfoAboutMedusaUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutMedusaChangelogs() throws IOException {
    ...
    public static void getInfoAboutMedusaChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutMedusaTalents() throws IOException {
