...
public class MonkeyKing {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Monkey_King/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Monkey_King/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/monkey-king/abilities";
    ...
    public static void getInfoAboutMonkeyKingFirstAbility() throws IOException {
    ...
    public static void getInfoAboutMonkeyKingSecondAbility() throws IOException {
    ...
    public static void getInfoAboutMonkeyKingThirdAbility() throws IOException {
    ...
    public static void getInfoAboutMonkeyKingUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutMonkeyKingChangelogs() throws IOException {
    ...
    public static void getInfoAboutMonkeyKingChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutMonkeyKingTalents() throws IOException {
