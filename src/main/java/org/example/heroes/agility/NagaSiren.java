...
public class NagaSiren {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Naga_Siren/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Naga_Siren/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/naga-siren/abilities";
    ...
    public static void getInfoAboutNagaSirenFirstAbility() throws IOException {
    ...
    public static void getInfoAboutNagaSirenSecondAbility() throws IOException {
    ...
    public static void getInfoAboutNagaSirenThirdAbility() throws IOException {
    ...
    public static void getInfoAboutNagaSirenUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutNagaSirenChangelogs() throws IOException {
    ...
    public static void getInfoAboutNagaSirenChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutNagaSirenTalents() throws IOException {
