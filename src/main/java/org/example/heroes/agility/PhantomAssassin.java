...
public class PhantomAssassin {
    ...
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/phantom-assassin/abilities";
    ...
    public static void getInfoAboutPhantomAssassinFirstAbility() throws IOException {
    ...
    public static void getInfoAboutPhantomAssassinSecondAbility() throws IOException {
    ...
    public static void getInfoAboutPhantomAssassinThirdAbility() throws IOException {
    ...
    public static void getInfoAboutPhantomAssassinUltimateAbility() throws IOException {
