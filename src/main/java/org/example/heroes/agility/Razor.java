...
public class Razor {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Razor/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Razor/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/razor/abilities";
    public static void getInfoAboutRazor() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/razor").get();
    ...
    public static void getInfoAboutRazorIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/razor/counters/").get();
    ...
    public static void getInfoAboutRazorCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/razor/counters/").get();
    ...
    public static void getInfoAboutRazorFirstAbility() throws IOException {
    ...
    public static void getInfoAboutRazorSecondAbility() throws IOException {
    ...
    public static void getInfoAboutRazorThirdAbility() throws IOException {
    ...
    public static void getInfoAboutRazorUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutRazorChangelogs() throws IOException {
    ...
    public static void getInfoAboutRazorChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutRazorTalents() throws IOException {
