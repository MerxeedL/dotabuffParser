...
public class Riki {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Riki/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Riki/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/riki/abilities";
    public static void getInfoAboutRiki() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/riki").get();
    ...
    public static void getInfoAboutRikiIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/riki/counters/").get();
    ...
    public static void getInfoAboutRikiCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/riki/counters/").get();
    ...
    public static void getInfoAboutRikiFirstAbility() throws IOException {
    ...
    public static void getInfoAboutRikiSecondAbility() throws IOException {
    ...
    public static void getInfoAboutRikiThirdAbility() throws IOException {
    ...
    public static void getInfoAboutRikiUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutRikiChangelogs() throws IOException {
    ...
    public static void getInfoAboutRikiChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutRikiTalents() throws IOException {
