...
public class ShadowFiend {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Shadow_Fiend/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Shadow_Fiend/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/shadow-fiend/abilities";
    public static void getInfoAboutShadowFiend() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/shadow-fiend").get();
    ...
    public static void getInfoAboutShadowFiendIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/shadow-fiend/counters/").get();
    ...
    public static void getInfoAboutShadowFiendCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/shadow-fiend/counters/").get();
    ...
    public static void getInfoAboutShadowFiendFirstAbility() throws IOException {
    ...
    public static void getInfoAboutShadowFiendSecondAbility() throws IOException {
    ...
    public static void getInfoAboutShadowFiendThirdAbility() throws IOException {
    ...
    public static void getInfoAboutShadowFiendUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutShadowFiendChangelogs() throws IOException {
    ...
    public static void getInfoAboutShadowFiendChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutShadowFiendTalents() throws IOException {
