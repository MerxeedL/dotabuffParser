...
public class Slark {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Slark/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Slark/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/slark/abilities";
    ...
    public static void getInfoAboutSlarkCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/slark/counters/").get();
    ...
    public static void getInfoAboutSlarkFirstAbility() throws IOException {
    ...
    public static void getInfoAboutSlarkSecondAbility() throws IOException {
    ...
    public static void getInfoAboutSlarkThirdAbility() throws IOException {
    ...
    public static void getInfoAboutSlarkUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutSlarkChangelogs() throws IOException {
    ...
    public static void getInfoAboutSlarkChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutSlarkTalents() throws IOException {
