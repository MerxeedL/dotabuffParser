...
public class Sniper {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Sniper/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Sniper/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/sniper/abilities";
    public static void getInfoAboutSniper() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/sniper").get();
    ...
    public static void getInfoAboutSniperIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/sniper/counters/").get();
    ...
    public static void getInfoAboutSniperCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/sniper/counters/").get();
    ...
    public static void getInfoAboutSniperFirstAbility() throws IOException {
    ...
    public static void getInfoAboutSniperSecondAbility() throws IOException {
    ...
    public static void getInfoAboutSniperThirdAbility() throws IOException {
    ...
    public static void getInfoAboutSniperUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutSniperChangelogs() throws IOException {
    ...
    public static void getInfoAboutSniperChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutSniperTalents() throws IOException {
