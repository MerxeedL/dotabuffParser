...
public class Spectre {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Spectre/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Spectre/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/spectre/abilities";
    public static void getInfoAboutSpectre() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/spectre").get();
    ...
    public static void getInfoAboutSpectreIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/spectre/counters/").get();
    ...
    public static void getInfoAboutSpectreCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/spectre/counters/").get();
    ...
    public static void getInfoAboutSpectreFirstAbility() throws IOException {
    ...
    public static void getInfoAboutSpectreSecondAbility() throws IOException {
    ...
    public static void getInfoAboutSpectreThirdAbility() throws IOException {
    ...
    public static void getInfoAboutSpectreUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutSpectreChangelogs() throws IOException {
    ...
    public static void getInfoAboutSpectreChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutSpectreTalents() throws IOException {
