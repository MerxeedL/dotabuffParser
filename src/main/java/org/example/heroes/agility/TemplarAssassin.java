...
public class TemplarAssassin {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Templar_Assassin/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Templar_Assassin/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/templar-assassin/abilities";
    public static void getInfoAboutTemplarAssassin() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/templar-assassin").get();
    ...
    public static void getInfoAboutTemplarAssassinIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/templar-assassin/counters/").get();
    ...
    public static void getInfoAboutTemplarAssassinCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/templar-assassin/counters/").get();
    ...
    public static void getInfoAboutTemplarAssassinFirstAbility() throws IOException {
    ...
    public static void getInfoAboutTemplarAssassinSecondAbility() throws IOException {
    ...
    public static void getInfoAboutTemplarAssassinThirdAbility() throws IOException {
    ...
    public static void getInfoAboutTemplarAssassinUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutTemplarAssassinChangelogs() throws IOException {
    ...
    public static void getInfoAboutTemplarAssassinChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutTemplarAssassinTalents() throws IOException {
