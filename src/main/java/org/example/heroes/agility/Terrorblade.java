...
public class Terrorblade {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Terrorblade/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Terrorblade/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/terrorblade/abilities";
    public static void getInfoAboutTerrorblade() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/terrorblade").get();
    ...
    public static void getInfoAboutTerrorbladeIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/terrorblade/counters/").get();
    ...
    public static void getInfoAboutTerrorbladeCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/terrorblade/counters/").get();
    ...
    public static void getInfoAboutTerrorbladeFirstAbility() throws IOException {
    ...
    public static void getInfoAboutTerrorbladeSecondAbility() throws IOException {
    ...
    public static void getInfoAboutTerrorbladeThirdAbility() throws IOException {
    ...
    public static void getInfoAboutTerrorbladeUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutTerrorbladeChangelogs() throws IOException {
    ...
    public static void getInfoAboutTerrorbladeChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutTerrorbladeTalents() throws IOException {
