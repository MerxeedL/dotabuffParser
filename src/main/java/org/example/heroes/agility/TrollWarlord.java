...
public class TrollWarlord {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Troll_Warlord/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Troll_Warlord/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/troll-warlord/abilities";
    public static void getInfoAboutTrollWarlord() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/troll-warlord").get();
    ...
    public static void getInfoAboutTrollWarlordIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/troll-warlord/counters/").get();
    ...
    public static void getInfoAboutTrollWarlordCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/troll-warlord/counters/").get();
    ...
    public static void getInfoAboutTrollWarlordFirstAbility() throws IOException {
    ...
    public static void getInfoAboutTrollWarlordSecondAbility() throws IOException {
    ...
    public static void getInfoAboutTrollWarlordThirdAbility() throws IOException {
    ...
    public static void getInfoAboutTrollWarlordUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutTrollWarlordChangelogs() throws IOException {
    ...
    public static void getInfoAboutTrollWarlordChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutTrollWarlordTalents() throws IOException {
