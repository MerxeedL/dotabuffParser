...
public class Ursa {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Ursa/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Ursa/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/ursa/abilities";
    public static void getInfoAboutUrsa() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ursa").get();
    ...
    public static void getInfoAboutUrsaIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ursa/counters/").get();
    ...
    public static void getInfoAboutUrsaCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/ursa/counters/").get();
    ...
    public static void getInfoAboutUrsaFirstAbility() throws IOException {
    ...
    public static void getInfoAboutUrsaSecondAbility() throws IOException {
    ...
    public static void getInfoAboutUrsaThirdAbility() throws IOException {
    ...
    public static void getInfoAboutUrsaUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutUrsaChangelogs() throws IOException {
    ...
    public static void getInfoAboutUrsaChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutUrsaTalents() throws IOException {
