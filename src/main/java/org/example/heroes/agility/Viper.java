...
public class Viper {
    private static final String URLLogs = "https://dota2.fandom.com/ru/wiki/Viper/Изменения";
    private static final String URLTalents = "https://dota2.fandom.com/ru/wiki/Viper/Таланты";
    private static final String URLAbilities = "https://www.dotabuff.com/heroes/viper/abilities";

    public static void getInfoAboutViper() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/viper").get();
    ...
    public static void getInfoAboutViperIsCounteredBy() throws IOException {

        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/viper/counters/").get();
    ...
    public static void getInfoAboutViperCounters() throws IOException {
        Document doc = Jsoup.connect("https://www.dotabuff.com/heroes/viper/counters/").get();
    ...
    public static void getInfoAboutViperFirstAbility() throws IOException {
    ...
    public static void getInfoAboutViperSecondAbility() throws IOException {
    ...
    public static void getInfoAboutViperThirdAbility() throws IOException {
    ...
    public static void getInfoAboutViperUltimateAbility() throws IOException {
    ...
    public static void getInfoAboutViperChangelogs() throws IOException {
    ...
    public static void getInfoAboutViperChangeUpdateLogs() throws IOException {
        Document doc = Jsoup.connect(URLLogs).get();
    ...
    public static void getInfoAboutViperTalents() throws IOException {
