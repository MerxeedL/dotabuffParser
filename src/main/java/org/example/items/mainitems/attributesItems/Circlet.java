...
public class Circlet {
    private static final String URL = "https://dota2.fandom.com/ru/wiki/Circlet";
    private static final String URLDB = "https://www.dotabuff.com/items/circlet";

    public static void getInfoAboutCircletBuildsInto() throws IOException {

        Document db = Jsoup.connect(URLDB).get();

        System.out.println("Circlet можно собрать в следующие предметы: ");
