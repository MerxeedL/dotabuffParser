...
public class Crown {
    private static final String URL = "https://dota2.fandom.com/ru/wiki/Crown";
    private static final String URLDB = "https://www.dotabuff.com/items/crown";

    public static void getInfoAboutCrownBuildsInto() throws IOException {

        Document db = Jsoup.connect(URLDB).get();

        System.out.println("Crown можно собрать в следующие предметы: ");
