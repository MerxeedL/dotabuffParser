...
public class OgreAxe {
    ...
    private static final String URLDB = "https://www.dotabuff.com/items/ogre-axe";

    public static void getInfoAboutOgreAxeBuildsInto() throws IOException {

        Document db = Jsoup.connect(URLDB).get();

        System.out.println("Ogre axe можно собрать в следующие предметы: ");
    ...
    public static void getInfoAboutChangelogs() throws IOException {
        ...
        System.out.println("Item Ogre Axe");
