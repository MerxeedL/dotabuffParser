...
public class RobeOfTheMagi {
    private static final String URL = "https://dota2.fandom.com/ru/wiki/Robe_of_the_Magi";
    private static final String URLDB = "https://www.dotabuff.com/items/robe-of-the-magi";

    public static void getInfoAboutRobeOfTheMagiBuildsInto() throws IOException {

        Document db = Jsoup.connect(URLDB).get();

        System.out.println("Robe of the magi можно собрать в следующие предметы: ");
    ...
    public static void getInfoAboutChangelogs() throws IOException {
        ...
        System.out.println("Item Robe of the magi");
