...
public class StaffOfWizardy {
    private static final String URL = "https://dota2.fandom.com/ru/wiki/Staff_of_Wizardry";
    private static final String URLDB = "https://www.dotabuff.com/items/staff-of-wizardry";

    public static void getInfoAboutStaffOfWizardryBuildsInto() throws IOException {

        Document db = Jsoup.connect(URLDB).get();

        System.out.println("Staff of wizardry можно собрать в следующие предметы: ");
    ...
    public static void getInfoAboutChangelogs() throws IOException {
        ...
        System.out.println("Item Staff of wizardry");
